                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 32),
                          child: Text(
                            "Knowledge of algorithms, data preprocessing, statistical analysis, programming, and model evaluation is essential.",
                            style: TextStyle(
